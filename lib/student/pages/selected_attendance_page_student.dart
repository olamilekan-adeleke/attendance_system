...
class SelectedAttendancePageStudent extends StatelessWidget {
  final AttendanceModel attendance;

  const SelectedAttendancePageStudent(this.attendance);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        children: [
          AttendanceInfoWidgetStudent(attendance),
          UserSignAttendanceListWidgetStudent(attendance.sId),
        ],
      ),
    );
  }
...
class AttendanceInfoWidgetStudent extends StatelessWidget {
  const AttendanceInfoWidgetStudent(this.attendance);
...
class UserSignAttendanceListWidgetStudent extends StatefulWidget {
  const UserSignAttendanceListWidgetStudent(this.attendanceId);

  final String attendanceId;

  @override
  _UserSignAttendanceListWidgetStudentState createState() =>
      _UserSignAttendanceListWidgetStudentState();
}

class _UserSignAttendanceListWidgetStudentState
    extends State<UserSignAttendanceListWidgetStudent> {
  @override
  void initState() {
    BlocProvider.of<UpdateAttendanceBloc>(context)
